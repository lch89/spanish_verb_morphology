...
if __name__ == "__main__":
	...
	#########
	# testVerb("to think")
	# testVerb("to close, shut")
	# testVerb("to be able, can")
	# testVerb("to request, ask for")	
	# testVerb("to recognize")
	# testVerb("to choose, select, pick")
	# testVerb("to follow, continue")
